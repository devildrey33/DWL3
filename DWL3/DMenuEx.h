...
namespace DWL {
	...
	class DMenuEx : protected DWL::DVentana {
		...
		virtual void					Evento_MostrarMenu(DMenuEx &mMenu)	{ 	};
										// Evento lambda que se lanza justo antes de mostrar este menú
		std::function<void(DMenuEx &)>	EventoMostrarMenu;

										// Evento virtual que se llama al hacer click en este menú
		virtual void					Evento_MouseClick(DMenuEx &mMenu)	{ 	};
										// Evento lambda que se lanza al hacer click en este menú
