...
#define COLOR_ROJO_SELECCION						RGB(251, 220, 220)
...
#define COLOR_BOTON_PRESIONADO						RGB(224,  70,  68)
...
#define COLOR_SCROLL_BORDE								COLOR_BORDE
#define COLOR_SCROLL_BORDE_RESALTADO					COLOR_BORDE_RESALTADO
#define COLOR_SCROLL_CONTROL_FONDO						COLOR_FONDO_CLARO
#define COLOR_SCROLL_CONTROL_FONDO_RESALTADO			COLOR_FONDO_CLARO_RESALTADO
//////////////////////////
// Oscuro ////////////////
//////////////////////////
#define COLOR_SCROLL_OSCURO_FONDO						COLOR_FONDO // RGB(225, 225, 225)
#define COLOR_SCROLL_OSCURO_FONDO_RESALTADO				COLOR_FONDO_RESALTADO
...
#define COLOR_SCROLL_OSCURO_CONTROL_FONDO_RESALTADO		COLOR_FONDO_RESALTADO
...
// Oscuro //////////////////
////////////////////////////
#define COLOR_ARBOL_OSCURO_FONDO							COLOR_FONDO
#define COLOR_ARBOL_OSCURO_FONDO_RESALTADO					RGB( 66,  64,  69)
#define COLOR_ARBOL_OSCURO_FONDO_PRESIONADO					COLOR_FONDO_PRESIONADO
#define COLOR_ARBOL_OSCURO_TEXTO							RGB(225, 225, 225)
#define COLOR_ARBOL_OSCURO_TEXTO_DESACTIVADO				RGB(128, 128, 128)
#define COLOR_ARBOL_OSCURO_TEXTO_SOMBRA						RGB( 30,  30,  30)
#define COLOR_ARBOL_OSCURO_TEXTO_RESALTADO					RGB(255, 255, 255)

#define COLOR_ARBOL_OSCURO_SELECCION						COLOR_ROJO
#define COLOR_ARBOL_OSCURO_SELECCION_RESALTADO				COLOR_ROJO_RESALTADO
#define COLOR_ARBOL_OSCURO_SELECCION_PRESIONADO				COLOR_ROJO_PRESIONADO
#define COLOR_ARBOL_OSCURO_SUBSELECCION						RGB(220,  170, 168)
#define COLOR_ARBOL_OSCURO_SUBSELECCION_RESALTADO			RGB(245,  190, 188)

#define COLOR_ARBOL_OSCURO_SELECCION_TEXTO					RGB(230, 230, 230)
#define COLOR_ARBOL_OSCURO_SELECCION_TEXTO_SOMBRA			RGB( 64,  64,  64)
#define COLOR_ARBOL_OSCURO_SELECCION_TEXTO_RESALTADO		RGB(255, 255, 255)
#define COLOR_ARBOL_OSCURO_SELECCION_TEXTO_PRESIONADO		RGB(190, 190, 190)
#define COLOR_ARBOL_OSCURO_SUBSELECCION_TEXTO				RGB(230, 230, 230)
#define COLOR_ARBOL_OSCURO_SUBSELECCION_TEXTO_SOMBRA		RGB(  0,   0,   0)
#define COLOR_ARBOL_OSCURO_SUBSELECCION_TEXTO_RESALTADO		RGB(255, 255, 255)

#define COLOR_ARBOL_OSCURO_EXPANSOR_NORMAL					RGB(100, 100, 100)
#define COLOR_ARBOL_OSCURO_EXPANSOR_RESALTADO				COLOR_ROJO_RESALTADO
#define COLOR_ARBOL_OSCURO_EXPANSOR_PRESIONADO				RGB( 32,  32,  32)

#define COLOR_ARBOL_OSCURO_NODO_MARCA						COLOR_BORDE_RESALTADO //RGB(255,   0,   0)
...
#define COLOR_LISTA_OSCURA_TEXTO_SOMBRA						RGB( 30,  30,  30)
#define COLOR_LISTA_OSCURA_TEXTO_RESALTADO					RGB(255, 255, 255)

#define COLOR_LISTA_OSCURA_SELECCION						COLOR_ROJO
#define COLOR_LISTA_OSCURA_SELECCION_RESALTADO				COLOR_ROJO_RESALTADO
#define COLOR_LISTA_OSCURA_SELECCION_PRESIONADO				COLOR_ROJO_PRESIONADO

#define COLOR_LISTA_OSCURA_SELECCION_TEXTO					RGB(230, 230, 230)
#define COLOR_LISTA_OSCURA_SELECCION_TEXTO_SOMBRA			RGB( 64,  64,  64)
#define COLOR_LISTA_OSCURA_SELECCION_TEXTO_RESALTADO		RGB(255, 255, 255)
#define COLOR_LISTA_OSCURA_SELECCION_TEXTO_PRESIONADO		RGB(190, 190, 190)

#define COLOR_LISTA_OSCURA_MARCA_ITEM						COLOR_BORDE_RESALTADO//RGB(255,   0,   0)
...
#define COLOR_EDICION_FONDO_SELECCION				COLOR_ROJO_SELECCION
...
#define COLOR_EDICION_TEXTO_PLACEHOLDER				RGB( 160, 160, 160)
#define COLOR_EDICION_TEXTO_PLACEHOLDER_SOMBRA		RGB(255, 255, 255)
